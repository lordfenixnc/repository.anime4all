...
base='http://www.anime4all.net'
ADDON=xbmcaddon.Addon(id='plugin.video.anime4allwizard')
dialog = xbmcgui.Dialog()    
VERSION = "1.0.1"
PATH = "anime4allwizard"            

    
def CATEGORIES():
    link = OPEN_URL('http://anime4all.net/image/wizard.txt').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("Anime4all Wizard","Downloading ",'', 'Please Wait')
