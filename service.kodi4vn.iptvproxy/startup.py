 ...
 headers = oO0o0o0ooO0oO )
   ...
   try :
    ...
    try :
     ...
     try :
      IiIi11iIIi1Ii = re . search ( "stream=_(\d+) \+ _(\d+)" , iI1Ii11111iIi . text )
      oO = IiIi11iIIi1Ii . group ( 1 )
      i1iiIIiiI111 = IiIi11iIIi1Ii . group ( 2 )
   ...
   ooOO00oOo = oo0o0O00 if "http://" in oo0o0O00 else "http://tv.beeb.vn" + oo0o0O00
   ooOO00oOo = requests . head (
 ooOO00oOo ,
 headers = oO0o0o0ooO0oO ) . headers [ "location" ]
   oooOOOOO = re . search ( 'VOD_RequestID=(.+?)($|&)' , ooOO00oOo ) . group ( 1 )
   ooOO00oOo = "http://27.67.80.6:18080/%s.m3u8?AdaptiveType=HLS&VOD_RequestID=%s" % ( Oo0oO0ooo , oooOOOOO )
  else :
...
def oOo0oooo00o ( text ) :
 ...
 iiiIi = [ ]
 for i1iiIIiiI111 , IiIIIiI1I1 in IiIi11iIIi1Ii :
